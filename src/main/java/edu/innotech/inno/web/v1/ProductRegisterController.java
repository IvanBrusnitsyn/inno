...
public class ProductRegisterController {
    ...
    public ResponseEntity<ProductRegisterListResponse> findAll() {
        return ResponseEntity.ok(
                productRegisterMapper.productRegisterListToProductRegisterListResponse(productRegisterService.findAll())
        );
    }
    @GetMapping("/{id}")
    ...
    public ResponseEntity<ProductRegisterResponse> update(@PathVariable("id") Long productRegisterId,
        ...
        ProductRegister updatedProductRegister = productRegisterService.update(
